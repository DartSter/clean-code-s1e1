...
var editTask=function(){
  ...
  if(containsClass){
    ...
    label.classList.remove("task__label_editeble")
    editInput.classList.remove("task__input_editeble")
  }else{
    editInput.value=label.innerText;
    editBtn.innerText = "Save";
    label.classList.add("task__label_editeble")
    editInput.classList.add("task__input_editeble")
  }
...
var taskCompleted=function(){
  ...
  var listItem = this.parentNode;
  let completeLabel = listItem.querySelector('.task__label')
  completeLabel.classList.add('task__label_completed')
...
var taskIncomplete=function(){
  ...
  var listItem = this.parentNode;
  let completeLabel = listItem.querySelector('.task__label')
  completeLabel.classList.remove('task__label_completed')
  incompleteTaskHolder.appendChild(listItem);
  bindTaskEvents(listItem,taskCompleted);
}
